...
const ProductForm: React.FC<ProductProps> = ({ initialData }) => {
    ...
    const handleAddOption = () => {
        if (selectedOption) {
            setAvailableListOptions(availableListOptions.filter((option) => option !== selectedOption));
                                    ...
                                    <CardContent className="mt-4 flex flex-col items-start gap-4">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <div className="flex gap-4 w-full">
                                                    ...
                                                    <Select value={selectedOption || ""} onValueChange={handleOptionChange} >
                                                        ...
                                                        <SelectContent position="popper" className="bg-white">
                                                            {availableListOptions.length > 0 && (
                                                                availableListOptions.map((option, index) => (
                                                                    <SelectItem key={index} value={option} disabled={isOptionDisable(option)}>{option}</SelectItem>
                                                                ))
                                                            )}
                                                        </SelectContent>
                                                    </Select>
                                                ...
                                                <div>
                                                    {/* <OptionForm value={ } onChange={ } onRemove={ } arrayOptions={availableListOptions} /> */}
                                                </div>
